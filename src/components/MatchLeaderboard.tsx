...
// We only accept the leads passed directly from the n8n response
export function MatchLeaderboard({ initialLeads }: { initialLeads?: LinkedInLead[] }) {
  const [leads] = useState<LinkedInLead[]>(initialLeads || []);
  ...
  // Since we aren't fetching, we don't need a loading spinner here anymore
