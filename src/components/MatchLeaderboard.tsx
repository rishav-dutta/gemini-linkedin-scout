...
// Added the interface to accept targetCompany
...
export function MatchLeaderboard({ targetCompany }: MatchLeaderboardProps) {
  ...
  // Updated useEffect to watch for company changes
  useEffect(() => {
    fetchLeads();
  }, [targetCompany]);
  ...
  const fetchLeads = async () => {
    ...
    try {
      ...
      if (data) {
        // FILTER ADDED HERE: 
        // This ensures the leaderboard only shows people matching your current search
